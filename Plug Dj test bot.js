...
(function() {
  ...
  steakCommand = (function(_super) {
    ...
    steakCommand.prototype.randomSteak = function() {
      var r, steaks;
      steaks = ["Mexican Pizza", "Chicken Soft Steak", "Double Decker Steak", "Volcano Steak Supreme", "Crunchy Steak Supreme", "Grilled Steak Soft Steak", "Cheesy Gordita Crunch", "Doritos Locos Steak"];
    ...
    if (plugRoomLinkPatt.exec(chat.message)) {
      ...
      if (!sender.ambassador && !sender.moderator && !sender.owner && !sender.superuser) {
        if (!data.users[chat.fromID]["protected"]) {
          ...
          return API.sendChat("I'm supposed to kick you, but your Persona prevents me from doing so.");
        }
      }
    }
  };
