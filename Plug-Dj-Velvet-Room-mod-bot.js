...
(function() {
    ...
    settings.prototype.songIntervalMessages = [
      {
        interval: 15,
        offset: 0,
        msg: "I'm a Velvet Room Attendant!"
      }
    ];
  ...
  cookieCommand = (function(_super) {
    ...
    cookieCommand.prototype.getCookie = function() {
      var c, cookies;
      cookies = ["a chocolate chip cookie", "a sugar cookie", "an oatmeal raisin cookie", "a 'special' brownie", "the PENGUIN animal cracker! Kanji's gonna be jealous!", "a scooby snack", "a blueberry muffin", "a cupcake"];
  ...
  rulesCommand = (function(_super) {
    ...
    rulesCommand.prototype.functionality = function() {
      var msg;
      msg = "1) Please only play music from the Shin Megami Tensei series (Persona, SMT, Catherine, Devil Survivor, Raidou Kuzunoha, etc)";
