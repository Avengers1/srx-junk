 ...
 ramenCommand = (function(_super) {
  ...
  cookieCommand = (function(_super) {
    ...
    cookieCommand.prototype.getCookie = function() {
      var c, cookies;
      cookies = ["Sweet Fries. This reminds Akihiko of this childhood!", "a Sugar Cookie. Junpei loves these!", "a Chocolate Truffle. Mitsuru's icy exterior broke down after eating one of these", "a Banana Cupcake. Yukari went, well, bananas over these", "the PENGUIN animal cracker! Kanji's gonna be jealous!", "one of Fuuka's terrible experiments...", "Mystery Food X! *vomits*"];
  ...
  punishCommand = (function(_super) {
    ...
    punishCommand.prototype.getPunishment = function(username) {
      ...
      punishments = ["/me summons Mara up @{victim}'s ass", "/me summons Daisoujou and Alice to cast Samsara and Die For Me at @{victim}", "/me sends the Reaper after @{victim}", "/me forces @{victim} to down a large bowl of Mystery Food X", "/me requests Mitsuru to execute @{victim}", "/me calls for an All Out Attack on @{victim}", "/me requests Elizabeth to cast a Megidolaon at @{victim}", "/me summons Helel and Satan to cast a Armageddon at @{victim}", "/me allows Chie to deliver a Galatic Punt to @{victim}'s crotch"];
  ...
  themeCommand = (function(_super) {
    ...
    themeCommand.prototype.functionality = function() {
      var msg;
      msg = "Join Crimzen, Theodore and other guests as they DJ the best of Persona and Shin Megami Tensei music as well as the host's own :)";
      return API.sendChat(msg);
    };
  ...
  lockCommand = (function(_super) {
    ...
    lockCommand.prototype.functionality = function() {
      API.sendChat('/me summons back all the Velvet Keys');
